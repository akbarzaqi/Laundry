...
<head>
    ...
    <title>We Serve You Better - Express Laundry</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #24256d;">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; akbarzaqi_ 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
