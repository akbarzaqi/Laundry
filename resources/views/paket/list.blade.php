...
<a href="{{ route('paket.create') }}" class="btn btn-primary mb-3" style="background-color: #24256d; color: white;">New Paket</a>
...
<table class="table table-bordered table-stripped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <a href="{{ route('paket.edit', $pkt->id) }}" class="btn mr-2 rounded-circle py-2" style="background-color: rgb(173, 173, 173);"><i class="fas fa-fw fa-pen text-white"></i></a>
